...
<svelte:head>
  <title>
   ...
   <div class="bg-gray-400 rounded-full col-span-4 h-12 flex items-center px-4 mb-3 border border-gray-400 text-white text-xl font-semibold">
   {equation}
   </div>
    ...
    <button class="bg-gray-300  hover:bg-gray-300/50"> CE </button>
